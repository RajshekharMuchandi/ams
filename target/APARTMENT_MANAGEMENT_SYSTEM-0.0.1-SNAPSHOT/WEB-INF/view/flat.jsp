...
$(document).ready(function() {
    ...
    $("#add_flat_button").click(function(event){
       $.getJSON('/ams/api/flat/', function(res) {
    	   console.log(res.flatId);
       });
    });
...
<body>
	<div class="container">
                ...
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                        <button type="button" id = "add_flat_button" class="btn btn-primary btn-block">Register</button>
                    </div>
                </div>
